...
export class ConnectionTester {
    static async testConnection(email, provider, customHost, customPort) {
    ...
    static testTcpConnection(host, port) {
    ...
    static testTlsConnection(host, port) {
        return new Promise((resolve) => {
            const options = {
                host,
                port,
    ...
    static testImapGreeting(host, port, useTls) {
        return new Promise((resolve) => {
            let socket;
            if (useTls) {
    ...
    static async suggestAlternatives(email) {
...
//# sourceMappingURL=connection-tester.js.map